...
if __name__ == "__main__":
    ...
    # response = search_engine.search(query="Parasita oscar 2020", exact=True)
    ranked_documents = search_engine.rank_documents(query="Parasita oscar 2020")

    for rank, (document, score) in enumerate(ranked_documents, start=1):
        print(f"Rank {rank}:")
        print(f"BM25 Similarity: {score:.4f}")
        print("Conteúdo:")
